...
tags: [style-detail, style_arch_001, metallic]
updated: 2026-05-05
parent: [[提示词风格库]]
via: [[风格库工作流与参考模板]]
source: outputs/projects/style-arch-001.md

- machine_name: style_arch_001
- human_name.zh: 金属模型（原：冷灰金属体块极简风）
- human_name.en: Metallic Model（原：Cool Gray Metallic Massing Minimalism）
...
## 4) 命名
- machine_name: style_arch_001
- human_name.zh: 金属模型（原名：冷灰金属体块极简风）
- human_name.en: Metallic Model（原名：Cool Gray Metallic Massing Minimalism）
...
- 原 human_name.en: Cool Gray Metallic Massing Minimalism
- 新 human_name.en: Metallic Model
- 说明：machine_name 保持 style_arch_001 不变；仅更新检索名与调用别名，不影响模板正文。